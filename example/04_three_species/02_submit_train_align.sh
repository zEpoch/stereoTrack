#!/bin/bash
# dsub 提交脚本：04_three_species alignment ablation

WORK_DIR="/home/share/huadjyin/home/zhoutao3/tracks/stereoTrack"
LOG_DIR="${WORK_DIR}/out/04_three_species_mae_v1_train_align_v1/job_logs"
...
echo "alignment 作业已提交，日志目录: ${LOG_DIR}"
