...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run inference for MERFISH mouse brain MAE checkpoints.")
    parser.add_argument(
        "--config",
        type=Path,
    ...
    parser.add_argument("--all-genes", action="store_true", help="Write all genes into X and layers. This is very large for MERFISH.")
