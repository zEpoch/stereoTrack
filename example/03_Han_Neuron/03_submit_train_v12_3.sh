...
LOG_DIR="${WORK_DIR}/out/03_han_mouse_brain_mae_v12_3/job_logs"
mkdir -p ${LOG_DIR}

TIMESTAMP=$(date +%Y%m%d_%H%M%S)

dsub \
    -n "03_han_mouse_brain_mae_v12_3" \
    -A "root.project.P23Z10200N0876" \
    -R "cpu=90;gpu=3;mem=140000" \
    -T "86400" \
    -N 1 \
    -oo "${LOG_DIR}/mae_train_${TIMESTAMP}.out" \
    -eo "${LOG_DIR}/mae_train_${TIMESTAMP}.err" \
    bash "${WORK_DIR}/train_pl.sh" /home/share/huadjyin/home/zhoutao3/tracks/stereoTrack/config/03_config_hanMouse3D_v12_3.yaml
