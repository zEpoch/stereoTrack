...
def parse_args() -> argparse.Namespace:
	...
	parser.add_argument(
		"--ortholog-file",
		type=Path,
		default=Path("/home/share/huadjyin/home/zhoutao3/tracks/stereoTrack/example/04_four_species/mart_export.humanMacaqeMarmosetMouse.oneToOneOrth.ensembl91.20220428.txt"),
		help="One-to-one ortholog table across human, macaque, marmoset and mouse.",
	)
	parser.add_argument(
		"--output-dir",
		type=Path,
		default=Path("/home/share/huadjyin/home/zhoutao3/tracks/stereoTrack/out/04_four_species_mae_v1"),
