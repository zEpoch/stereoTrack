...
LOG_DIR="${WORK_DIR}/out/02_macaque_brain_mae_v2/job_logs"
...
dsub \
    -n "02_macaque_brain_mae_v2" \
    -A "root.project.P23Z10200N0876_tmp" \
    -R "cpu=128;gpu=4;mem=180000" \
    -T "86400" \
    -N 1 \
    -oo "${LOG_DIR}/mae_train_${TIMESTAMP}.out" \
    -eo "${LOG_DIR}/mae_train_${TIMESTAMP}.err" \
    bash "${WORK_DIR}/train_pl.sh" /home/share/huadjyin/home/zhoutao3/tracks/stereoTrack/config/02_config_Chen_Cell_v2.yaml
