...
LOG_DIR="${WORK_DIR}/out/02_macaque_brain_mae_v4/job_logs"
...
dsub \
    ...
    bash "${WORK_DIR}/train_pl.sh" /home/share/huadjyin/home/zhoutao3/tracks/stereoTrack/config/02_config_Chen_Cell_v4.yaml
